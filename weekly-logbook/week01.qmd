...
| [Barbell](#barbell) | **No**, at least not its main use case. | **No** | **Yes** (It uses subsequence kernel of Lodhi that favors matches that tighly together) | It can detect inner barcode, barcode appear after it found the barcode |
